...
namespace DemoKystova
{
    public partial class Partner
    {
        ...
        {
            var productCount = GetProductCount(partnerId);//получение кол-ва продуктов данного партнера
        ...
        public string Discount => GetDiscount(id_partner) + "%"; // форматирование вывода 
